...
urlpatterns = [
    ...
    path('unsubscribe/success/', views.unsubscribe_success_view,
    ...
    path('<int:year>/<int:month>/<int:day>/<slug:sermon>/',
         views.sermon_detail, name='sermon_detail'),

    path('careers/', views.career_list, name='careers'),

    path('committees/', views.committees, name='committees'),

    path('<int:year>/<int:month>/<int:day>/<slug:career>/',
         views.career_detail, name='career_detail'),
